...
const UpdateForm = ({ defaultData }) => {
    const router = useRouter()
    const [noOfCustomer, setNoOfCustomer] = useState(defaultData.noOfCustomer)
    const [offerPerCustomer, setOfferPerCustomer] = useState(defaultData.offerUsePerCustomer)
        ...
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="mt-5 flex items-center justify-center">
                    <button className="text-base ml-2 hover:scale-110 focus:outline-none flex justify-center px-14 py-2 rounded font-semibold cursor-pointer hover:bg-red-00  bg-red-900 text-red-100 border duration-200 ease-in-out border-red-900 transition" type='submit'>Update Offer</button>
                </div>
